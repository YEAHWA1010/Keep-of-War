...
ACPlayer::ACPlayer()
{
	...
	USkeletalMesh* mesh;
	CHelpers::GetAsset<USkeletalMesh>(&mesh,"SkeletalMesh'/Game/Characters/Mesh/KOW_Mannequin_Default.KOW_Mannequin_Default'");
...
void ACPlayer::BeginPlay()
{
	...
	HealthPoint->OnHealthPointChanged.AddDynamic(this, &ACPlayer::OnHealthPointChanged);
...
void ACPlayer::OnSubAction()
{
	...
	UserInterface->UpdateCrossHairVisibility(true);
...
void ACPlayer::Change_Color(const FLinearColor& InColor)
{
