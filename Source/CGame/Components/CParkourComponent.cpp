...
void UCParkourComponent::CheckTrace_Land()
{
	...
	UKismetSystemLibrary::LineTraceSingle(GetWorld(),start,end,ETraceTypeQuery::TraceTypeQuery1,false,ignores,EDrawDebugTrace::None,HitResults[(int32)EParkourArrowType::Land],true,color,FLinearColor::White);
}
...
void UCParkourComponent::LineTrace(EParkourArrowType InType)
{
	...
	UKismetSystemLibrary::LineTraceSingle(GetWorld(),start,end,ETraceTypeQuery::TraceTypeQuery3,false,ignores,EDrawDebugTrace::None,HitResults[(int32)InType],true,color,FLinearColor::White);
}
...
bool UCParkourComponent::Check_SlideMode()
{
	...
	UKismetSystemLibrary::BoxTraceSingle(GetWorld(),start,end,FVector(0,extent,extent),OwnerCharacter->GetActorRotation(),TraceTypeQuery1,false,ignores,EDrawDebugTrace::None,hitResult,true,color,FLinearColor::White);
